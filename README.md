...
[![GoDoc](http://godoc.org/github.com/timsimmons/go-netbox?status.svg)](http://godoc.org/github.com/timsimmons/go-netbox) [![Build Status](https://github.com/timsimmons/go-netbox/workflows/main/badge.svg?branch=master)](https://github.com/timsimmons/go-netbox/actions) [![Report Card](https://goreportcard.com/badge/github.com/timsimmons/go-netbox)](https://goreportcard.com/report/github.com/timsimmons/go-netbox)

Package `netbox` provides an API 2.0 client for [timsimmons's NetBox](https://github.com/timsimmons/netbox)
...
```golang
import (
    "github.com/timsimmons/go-netbox/netbox"
)
...
...
`go get github.com/timsimmons/go-netbox`
